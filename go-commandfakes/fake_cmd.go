...
type FakeCmd struct {
	...
	GetProcessStub        func() *os.Process
...
func (fake *FakeCmd) GetProcess() *os.Process {
...
func (fake *FakeCmd) GetProcessReturns(result1 *os.Process) {
...
func (fake *FakeCmd) GetProcessReturnsOnCall(i int, result1 *os.Process) {
	fake.GetProcessStub = nil
